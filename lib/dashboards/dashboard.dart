...
class _DashboardsState extends State<Dashboards> {
  ...
  Future<void> getTerminalSelect() async {
    selectedBaseStationID = (baseStationList2.isNotEmpty ? baseStationList2[0].cityid : null)!;
...
*/
                  ...
                  child: Wrap(
                    ...
                    children: List<Widget>.generate(
                      ...
                      (int index) {
                       ...
                       // selectedBaseStationBranchID = dummyList.isNotEmpty ? dummyList[0].orgBranchName : null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: (useMobileLayout) ? FloatingActionButton.extended(
                        ...
                        onPressed: () {
                          ...
                          if (selectedBaseStationBranchID == 0) {
                            showAlertDialog(
                                ...
                                "${localizeLangModel!.ok}",
                                "${localizeLangModel.alert}",
                                "${localizeLangModel.select} ${localizeLangModel.terminal}");
                            print("terminal");
                          }
                        },
                        //padding: const EdgeInsets.all(0.0),
